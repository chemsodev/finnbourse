    ...
    <>
      <div className="flex flex-col items-center justify-center w-full h-full gap-12 py-8">
        ...
        >
          ...
          <g id="freepik--Padlock--inject-3">
            <path
              ...
              className="fill-none stroke-primary stroke-linecap-round stroke-linejoin-round stroke-[1.166343341900884px]"
            ></path>
            <rect
              x="65.14"
              y="179.87"
          ...
          <g id="freepik--Character--inject-3">
            <polygon
              ...
              className="fill-primary stroke-primary stroke-linecap-round stroke-linejoin-round stroke-[1.166343341900884px]"
            ></polygon>
            <path
              ...
              className="fill-gray-300 stroke-primary stroke-linecap-round stroke-linejoin-round stroke-[1.166343341900884px]"
            ></path>
            <path
            ...
            <path
              ...
              className="fill-orange-500 stroke-primary stroke-linecap-round stroke-linejoin-round stroke-[1.166343341900884px]"
            ></path>
            <path
              ...
              className="fill-gray-200 stroke-primary stroke-linecap-round stroke-linejoin-round stroke-[1.166343341900884px]"
            ></path>
            <polygon
            ...
            <rect
              ...
              width="13.19"
              height="8.42"
              className="fill-white stroke-primary stroke-linecap-round stroke-linejoin-round stroke-[1.166343341900884px]"
            ></rect>
            <path
          ...
          <g id="freepik--Text--inject-3">
            ...
            ></path>
            <path
              d="M332.33,260c0-3.33,1.66-5.48,5-5.48s5,2.15,5,5.48v11.28c0,3.3-1.65,5.48-5,5.48s-5-2.18-5-5.48Zm2.4,11.4c0,2,.84,3.15,2.59,3.15s2.58-1.15,2.58-3.15V259.87c0-2-.81-3.15-2.58-3.15s-2.59,1.18-2.58,3.15Z"
              className="fill-primary"
            ></path>
            <path
          ...
          <g id="freepik--security-barrier--inject-3">
            <polygon
              ...
              className="fill-primary stroke-primary stroke-miterlimit-10 stroke-[1.166343341900884px]"
            ></polygon>
            <polygon
              points="115.39 446.5 129.64 446.5 110.63 313.99 96.38 313.99 115.39 446.5"
              className="fill-white stroke-primary stroke-miterlimit-10 stroke-[1.166343341900884px]"
            ></polygon>
            <polygon
            ...
            <rect
              ...
              width="271.93"
              height="26.36"
              className="fill-orange-500 stroke-primary stroke-miterlimit-10 stroke-[1.166343341900884px]"
            ></rect>
            <rect
              x="62.36"
              y="293.21"
            ...
            <line
              ...
              x2="287.8"
              y2="304.9"
              className="fill-none stroke-primary stroke-miterlimit-10 stroke-[1.166343341900884px]"
            ></line>
            <line
              x1="332.01"
              y1="309.31"
        ...
        <div className="flex flex-col items-center gap-4">
          <h1 className="text-4xl font-medium text-center text-orange-500">
            {t("title")}
          </h1>
