...
const AjoutTitre = ({ type }: { type: string }) => {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      await fetchGraphQL<String>(mutation, {
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)}>
                <DialogDescription className="space-y-8 max-w-3xl mx-auto pt-10 w-[40vw]">
                                ...
                                <FormItem className="w-full">
                                  ...
                                  >
                                    ...
                                    <SelectContent>
                                      ...
                                      <SelectItem value="Capital constant">
                                        {t("parCapitalConstant")}
                                      </SelectItem>
                                    </SelectContent>
                                  </Select>
                          ...
                          (type === "titresparticipatifsmp" && (
                            <div className="flex gap-4">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem className="w-full">
                                    <FormLabel>{t("tauxFixe")}</FormLabel>
                                    <FormControl>
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem className="w-full">
                                    <FormLabel>{t("tauxVariable")}</FormLabel>
                                    <FormControl>
                                      <Input
                                        placeholder="Base + 2.5%"
                                        {...field}
                                      />
                                    </FormControl>
                                    <FormMessage />
                        ...
                        {(type === "sukukms" || type === "sukukmp") && (
                          <div className="flex gap-4">
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem className="w-full">
                                  <FormLabel>{t("tauxEstime")}</FormLabel>
                                  <FormControl>
                                    <Input
                                      placeholder="Taux estimé"
                                      {...field}
                                    />
                                  </FormControl>
                                  <FormMessage />
                  ...
                  {(type === "opv" || type === "empruntobligataire") && (
                    <div className="w-full">
                      <FormField
                        control={form.control}
                        name="closingDate"
                        render={({ field }) => (
                          <FormItem className="flex flex-col">
                            <FormLabel>{t("dateClôture")}</FormLabel>
                            <Popover>
                              <PopoverTrigger asChild>
                                <FormControl>
                                  <Button
