  ...
  return (
    <div>
      <button
        ...
        className="flex items-center gap-4 py-2 px-6 w-full rounded-md hover:bg-green-600/20 hover:text-primary hover:shadow-sm text-left cursor-pointer"
      >
        <Calculator className="w-8" /> {titre}
        <motion.span
