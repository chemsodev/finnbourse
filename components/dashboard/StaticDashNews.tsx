...
const StaticDashNews = () => {
  ...
  const mockNews = [
    {
      ...
      content: "Le secteur énergétique a affiché une croissance remarquable cette semaine avec les grandes entreprises rapportant des profits accrus et des perspectives positives pour le Q4.",
    ...
    },
    {
      ...
      content: "L'autorité de régulation a annoncé de nouvelles directives pour le trading de titres qui entreront en vigueur le mois prochain, améliorant la transparence.",
    ...
    },
    {
      ...
      content: "Les entreprises technologiques continuent leur tendance haussière alors que les investisseurs montrent leur confiance dans les initiatives de transformation numérique.",
    ...
    },
    {
      ...
      content: "La volatilité récente du marché a impacté les actions bancaires, avec les analystes prédisant une approche prudente dans les mois à venir.",
  ...
  return (
    <>
      <h2 className="text-[1vw] font-semibold text-gray-900 mb-3">Dernières Actualités</h2>
          ...
          <div style={{ maxHeight: '25vw', overflow: 'auto' }}>
            <div className="">
              {displayedNews.map((article, index) => (
                <div
                  key={article.id}
                  className={`group w-full relative border-b border-gray-100 transition-all duration-200 cursor-pointer ${getPriorityColor(index)}`}
                >
                  <div className="flex items-start justify-between gap-4 p-[0.5vw]">
                    <div className="flex-1 min-w-0">
                      <div className="flex w-full justify-end mb-1">
                        <span className="font-normal text-[0.5vw] flex justify-end">{formatDate(article.publishedAt)}</span>
                      </div>
